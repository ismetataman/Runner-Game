...
public class MarketItem : MonoBehaviour
{
    ...
    public bool HasItem()
    {
        ...
        // 1: satin alinmis ama giyilmemis
        // 2: hem satin alinmis hem de giyilmis
    ...
    public void BuyItem()
    {
        if(!HasItem())
        {
            ...
            if (money >= price)
            {
                ...
                PlayerPrefs.SetInt("item"+ itemId.ToString(),1); // satin alinmis ama giyilmemis 1 o yuzden 1 e esitledik
                buyButton.gameObject.SetActive(false);
                equipButton.gameObject.SetActive(true);
            }
        }
    ...
    public void EquipItem()
    {
        ...
        MarketController.Current.equippedItems[wearId]= Instantiate(itemPrefab, PlayerController.Current.wearSpots[wearId].transform).GetComponent<Item>();
         ...
         PlayerPrefs.SetInt("item"+ itemId.ToString(), 2); //hem satin alinmis hem giyilmis anlamina gelen 2 ye esitledik
    ...
    public void UnequipItem()
    {
        ...
        if(equippedItem != null)
        {
            ...
            PlayerPrefs.SetInt("item"+ marketItem.itemId,1); //ustunden cikarttigim icin 1 yaptik satin alinmis ama giyilmemis olarak
